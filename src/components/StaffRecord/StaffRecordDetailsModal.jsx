  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 pb-2">
        ...
        {hasProduction && (
          <div>
            <SectionHeader icon={Layers} title={`Production — ${productionRows} ${productionRows === 1 ? "Row" : "Rows"}`} color="text-blue-400" />
        ...
        {hasBonus && (
          <div>
            <SectionHeader icon={Gift} title="Bonus" color="text-violet-400" />
            <InfoGrid col={3}>
