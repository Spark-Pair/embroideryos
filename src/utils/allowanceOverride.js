...
export const ALLOWANCE_OVERRIDE_OPTIONS = [
  { label: "Force Add", value: ALLOWANCE_OVERRIDE_MODES.FORCE_ADD },
  { label: "Force Remove", value: ALLOWANCE_OVERRIDE_MODES.FORCE_REMOVE },
];
...
export const formatAllowanceOverrideMode = (mode = "") => {
  if (mode === ALLOWANCE_OVERRIDE_MODES.FORCE_ADD) return "Force Add";
  if (mode === ALLOWANCE_OVERRIDE_MODES.FORCE_REMOVE) return "Force Remove";
  return "";
};
